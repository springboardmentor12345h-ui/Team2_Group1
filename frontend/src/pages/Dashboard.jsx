                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-4">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-gray-900">CampusEventHub</h1>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="flex items-start justify-between">
                            <div>
                                ...
                                <p className="text-primary-100 mb-4">
                                    Browse events, register for activities, and stay updated with campus happenings.
                                </p>
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex-1">
                                ...
                                <p className="text-green-100 mb-4">
                                    Create and manage events, approve registrations, and monitor analytics.
                                </p>
                        ...
                        {upcomingEvents.map((event) => (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    {/* Category Badge */}
                                    <div className="mb-3">
                                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold border ${getCategoryColor(event.category)}`}>
                                            {event.category}
                                        </span>
                                    </div>
                ...
                {upcomingEvents.length === 0 && (
                    <div className="bg-white rounded-xl shadow-card p-12 text-center">
                        ...
                        <p className="text-gray-600 mb-6">Check back later for new events and activities.</p>
                        {(user.role === 'college_admin' || user.role === 'super_admin') && (
