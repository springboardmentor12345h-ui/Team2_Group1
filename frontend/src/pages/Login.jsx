            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-2xl shadow-card p-8 sm:p-10">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-secondary-500 text-sm">Sign in to your CampusEventHub account</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="bg-primary-50 border border-primary-200 rounded-lg p-3">
                            <p className="text-xs font-semibold text-primary-900 mb-1">DEMO CREDENTIALS:</p>
                            <p className="text-xs text-primary-700 font-mono">
                                Student: user@university.edu / password123
                            </p>
                            <p className="text-xs text-primary-700 font-mono">
                                College Admin: admin@university.edu / password123
                            </p>
                        </div>
